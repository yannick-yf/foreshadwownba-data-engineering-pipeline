...
import pandas as pd
import datetime
from functions import GetNbaWebScrapDataCombinedCleaned
...
if __name__ == '__main__':
    ...
    nba_games_multi_season_dataset = GetNbaWebScrapDataCombinedCleaned.fn_get_seasons_nba_games_data(season_to_pull)
    ...
    method_start_time = datetime.datetime.now()
    nba_schedules_multi_season_dataset = GetNbaWebScrapDataCombinedCleaned.fn_get_seasons_nba_schedules_overtime_data(season_to_pull)
    method_end_time = datetime.datetime.now()
    duration = method_end_time - method_start_time
    ...
    method_start_time = datetime.datetime.now()
    training_dataset = GetNbaWebScrapDataCombinedCleaned.cleaned_and_combined(nba_games_multi_season_dataset, nba_schedules_multi_season_dataset)
    method_end_time = datetime.datetime.now()
    duration = method_end_time - method_start_time
    ...
    #------------------------------------------------
    # Save the dataframe for the training package (foreshadwownba-ml)
