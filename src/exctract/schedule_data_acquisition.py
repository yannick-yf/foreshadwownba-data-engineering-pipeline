...
logger = get_logger(
    "SCHEDULE_DATA_ACQUISITION", log_level='INFO'
)

def schedule_data_acquisition(
        data_type: str = 'schedule',
        season: int = 2024,
        team: str ='all',
        output_folder: Path = 'pipeline_output/schedule/'
        ) -> None:
    """
    ...
    Args:
        ...
        output_folder (Path): Path where to save the schedule data pulled using the package.
    """
...
def get_args():
    ...
    schedule_data_acquisition_params = params["schedule_data_acquisition"]
    ...
    parser.add_argument(
        ...
        dest="output_folder",
        type=Path,
        default=schedule_data_acquisition_params["output_folder"],
    )
    ...
    parser.add_argument(
        ...
        dest="data_type",
        type=str,
        default=schedule_data_acquisition_params["data_type"],
    )
    ...
    parser.add_argument(
        ...
        dest="team",
        type=str,
        default=schedule_data_acquisition_params["team"],
    )
